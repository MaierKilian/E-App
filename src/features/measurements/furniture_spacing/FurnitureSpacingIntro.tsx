...
import { DoorOpen, ListChecks, Lightbulb } from 'lucide-react'
    ...
    <div className="space-y-4">
      <div>
        ...
        <h2 className="mt-1 text-xl font-bold text-foreground">
          {t('measurements.furniture_spacing.title')}
        </h2>
        <p className="mt-2 text-sm text-muted">{t('measurements.furniture_spacing.intro.lead')}</p>
      </div>
